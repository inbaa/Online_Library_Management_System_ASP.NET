<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="BOOK_issue_guest.aspx.cs" Inherits="WebApplication21.BOOK_issue_guest" %>
   ...
   <br /> 
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <asp:TextBox CssClass="form-control" ID="department" runat="server" Enabled="false" />
            ...
            <div class="col">
                ...
                <asp:TextBox CssClass="form-control" ID="designation" runat="server" Enabled="false" />
                <!-- <input class="form-control"  id="authorName" name="authorName" type="text" required/> -->
            </div>
        </div>
...
<div id="col2" class="column">
                ...
                <br />
<center>
    <h4>Book/s issued to this guest:</h4>
    <asp:GridView 
        ID="GridView1" 
        runat="server" 
