...
{
    public partial class BOOK_issue_guest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dueDate.Text = DateTime.Now.AddDays(15).ToString("dd-MM-yyyy");
        }
        ...
        bool checkMemberExist()
        {
            ...
            try
            {
                ...
                //grid view for all the books user issued and active
                MySqlCommand cmd = new MySqlCommand("select DOB from guest_signup WHERE UserId ='" + userId.Text.Trim() + "'  ", con);
                MySqlDataAdapter da = new MySqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        bool checkIfEntryExist()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from book_issue_guest WHERE userId='" + userId.Text.Trim() + "' and bookLNo='" + bookLNo.Text.Trim() + "' and status= 'active' ", con);
        ...
        void search()
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("select  Full_Name, Designation, Dept_Name from guest_signup WHERE  userId  ='" + userId.Text.Trim() + "'  ", con);
                ...
                if (dtt.Rows.Count >= 1)
                {
                    ...
                    designation.Text = dtt.Rows[0]["Designation"].ToString();
                    department.Text = dtt.Rows[0]["Dept_Name"].ToString();
                    
                }

                //grid view for all the books issued by this user and active
                cmd = new MySqlCommand("select userName as 'User Name',Dept_Name as 'Department', Designation, bookName as 'Book Name', authorName as 'Author Name', issueDate as 'Issue Date', dueDate as 'Due Date', rack as 'Rack' from book_issue_guest WHERE userId='" + userId.Text.Trim() + "' and status= 'active' ", con);
                ...
                if (dt.Rows.Count >= 4)
                {
                    ...
                    Response.Write("<script>alert('Cannot issue more than 4 Books to a Guest')</script>");
                    userId.Text = "";
                    bookLNo.Text = "";
                    userName.Text = "";
                    bookName.Text = "";
        ...
        void bookIssue()
        {
            ...
            try
            {
                ...
                */
                ...
                MySqlCommand cmd = new MySqlCommand("insert into Book_Issue_Guest (userId,userName,bookLNo,bookName,authorName,issueDate,dueDate,Dept_Name,Designation,status,rack) values(@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10,@a11)", con);
                cmd.Parameters.AddWithValue("@a1", userId.Text.Trim());
                cmd.Parameters.AddWithValue("@a2", userName.Text.Trim());
                cmd.Parameters.AddWithValue("@a3", bookLNo.Text.Trim());
                ...
                cmd.Parameters.AddWithValue("@a8", department.Text.Trim());
                cmd.Parameters.AddWithValue("@a9", designation.Text.Trim());
                cmd.Parameters.AddWithValue("@a10", "active");
                cmd.Parameters.AddWithValue("@a11", rack.Text.Trim());
                cmd.ExecuteNonQuery();
