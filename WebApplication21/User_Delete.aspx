<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" Codefile="User_Delete.aspx.cs" Inherits="WebApplication21.User_Delete" %>
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="UserId" DataSourceID="SqlDataSource1">
                           <Columns>
                              ...
                              <asp:BoundField DataField="Register_no" HeaderText="Register_no" SortExpression="Register_no" />
