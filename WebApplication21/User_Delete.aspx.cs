    ...
    public partial class User_Delete : System.Web.UI.Page
    {
        ...
        bool checkIfMemberExists()
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from st_signup where Register_no='" + TextBox1.Text.Trim() + "';", con);
        ...
        void deleteMemberByID()
        {
            if (checkIfMemberExists())
            {
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand("DELETE from st_signup WHERE Register_no='" + TextBox1.Text.Trim() + "'", con);
