<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="Staff_Delete.aspx.cs" Inherits="WebApplication21.Staff_Delete" %>
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="UserId" DataSourceID="SqlDataSource1">
                           <Columns>
                              ...
                              <asp:BoundField DataField="DESIGINATION" HeaderText="course" SortExpression="course" />
