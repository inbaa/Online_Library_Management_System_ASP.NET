<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="Book_issue1.aspx.cs" Inherits="WebApplication21.Book_issue1" %>
   ...
   <br /> 
           <div class="row">
            ...
            <div class="col">
                ...
                <asp:TextBox CssClass="form-control" ID="userId" placeholder="Staff ID" runat="server" onFocus="userIdChange(this)" />
                <!-- validation -->
