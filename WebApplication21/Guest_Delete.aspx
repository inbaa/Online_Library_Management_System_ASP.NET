<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="Guest_Delete.aspx.cs" Inherits="WebApplication21.Guest_Delete" %>
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" Width="17px" ><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:libraryConnectionString2 %>" ProviderName="<%$ ConnectionStrings:libraryConnectionString2.ProviderName %>" SelectCommand="select * from (st_signup)"></asp:SqlDataSource>
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="UserId" DataSourceID="SqlDataSource1">
                           <Columns>
                           <asp:BoundField DataField="user_id" HeaderText="user_id" ReadOnly="True" SortExpression="UserId" InsertVisible="False" />
                              <asp:BoundField DataField="Full_Name" HeaderText="Name" SortExpression="Full_Name" />
                              <asp:BoundField DataField="DoB" HeaderText="DOB" SortExpression="DOB" />
           
                              <asp:BoundField DataField="CONTACT_NO" HeaderText="Mobile No" SortExpression="contact_no" />
                              <asp:BoundField DataField="MAIL_ID" HeaderText="Email" SortExpression="mail_id" />
                              <asp:BoundField DataField="DESIGINATION" HeaderText="course" SortExpression="desigination" />
                           </Columns>
                        </asp:GridView>
                     </div>
                  </div>
