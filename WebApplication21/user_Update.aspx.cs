...
namespace WebApplication21
{
    public partial class user_Update : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["regno"].ToString() == "" || Session["regno"] == null)
                {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("update st_signup set Full_Name=@Full_Name, DOB=@DOB, contact_no=@contact_no, mail_id=@mail_id, course=@course, batch=@batch,password=@password,where Register_no='" + Session["regno"].ToString().Trim() + "'", mycon);
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from st_signup where Register_no='" + Session["regno"].ToString() + "';", mycon);
                ...
                TextBox7.Text = dt.Rows[0]["batch"].ToString();
        ...
        void getUserBookData()
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from bookissue where userId='" + Session["regno"].ToString() + "';", mycon);
                MySqlDataAdapter da = new MySqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
