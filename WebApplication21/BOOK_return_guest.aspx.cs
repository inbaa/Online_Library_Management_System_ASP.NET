...
{
    public partial class BOOK_return_guest : System.Web.UI.Page
    {
        ...
        protected void userIdChanged(Object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select userName as 'User Name',Dept_Name as 'Department', Designation, bookLNo as 'Book L No', bookName as 'Book Name', authorName as 'Author Name', issueDate as 'Issue Date', dueDate as 'Due Date', rack as 'Rack' from book_issue_guest WHERE userId='" + userId.Text.Trim() + "' and status= 'active' ", con);
                ...
                {
                    Response.Write("<script>alert('This guest has not issued any book.')</script>");
                    userId.Text = "";
                    dueDate.Text = "";
                    remark.Text = "Nil";
                    penalty.Text = "";
        ...
        protected void bookLNoChanged(Object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select dueDate, issueDate, rack, dept_name, designation from book_issue_guest WHERE userId='" + userId.Text.Trim() + "' and bookLNo='" + bookLNo.Text.Trim() + "' and status= 'active' ", con);
                MySqlDataAdapter da = new MySqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                    ...
                    department.Text= dt.Rows[0]["dept_name"].ToString();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("update book_issue_guest SET status = 'inactive' where userId='" + userId.Text.Trim() + "' and bookLNo='" + bookLNo.Text.Trim() + "' and status= 'active' ", con);
                cmd.ExecuteNonQuery();
                ...
                if (result > 0)
                {
                    ...
                    cmd = new MySqlCommand("insert into book_return_guest(userId,bookLNo,issueDate,dueDate,returnDate,remark,penalty,Dept_Name,Designation) values(@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9)", con);
