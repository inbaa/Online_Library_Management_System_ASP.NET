...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2021 at 07:47 PM
...
--
-- Dumping data for table `book_issue_guest`
--

INSERT INTO `book_issue_guest` (`bookIssueId`, `userId`, `userName`, `bookLNo`, `bookName`, `authorName`, `issueDate`, `dueDate`, `Dept_Name`, `Designation`, `status`, `rack`) VALUES
(1, '101', 'aaa', 'L2075', 'MINING THE SOCIAL WEB', 'MATTHEW A.RUSSELL', '20-01-2021', '04-02-2021', 'Economics', 'Guest Lecture', 'inactive', 'R43DM037');
...
--
-- Dumping data for table `book_return_guest`
--

INSERT INTO `book_return_guest` (`bookReturnId`, `userId`, `bookLNo`, `issueDate`, `dueDate`, `returnDate`, `remark`, `penalty`, `Dept_Name`, `Designation`) VALUES
(1, '101', 'L2075', '20-01-2021', '04-02-2021', '21-01-2021', 'Nil', '0', 'Economics', 'Guest Lecture');
...
--
-- Dumping data for table `guest_signup`
--

INSERT INTO `guest_signup` (`guestSignupId`, `UserId`, `Full_Name`, `contact_no`, `DOB`, `Designation`, `Dept_Name`, `mail_id`, `Password`) VALUES
(1, '101', 'aaa', '6234567890', '2021-01-12', 'Guest Lecture', 'Economics', 'asasas@gmail.com', 'guest');
...
--
ALTER TABLE `book_issue_guest`
  MODIFY `bookIssueId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `guest_signup`
  MODIFY `guestSignupId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
